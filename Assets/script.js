...
//loop to create block for each working hour
for(var i = 0; i < hours.length ;i++)
{
    let str = hours[i];
    let newAttrVal = str+"block"; 

    //declaring a variable to get the text input value from local storage
